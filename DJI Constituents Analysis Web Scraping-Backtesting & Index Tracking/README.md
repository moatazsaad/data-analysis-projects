...
## Web Scraping Dow Jones Constituents
- Scraping the Dow Jones Industrial Average (DJI) constituents from Wikipedia to gather the list of stocks included in the index.

## Loading and Saving Historical Stock Prices
- Utilizing Yahoo Finance API (`yfinance`) to download historical stock prices for both the DJI index and its constituents.
- Data is then saved into CSV files for further analysis.
...
- Comparing the performance of the optimized tracking portfolio with 10,000 randomly generated portfolios to assess its effectiveness.
